#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Sep 15 23:05:55 BST 2023      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmi2 --mem-per-cpu=30720 nice -n 10 /usr/bin/python3 ./check_for_Xmatch_in_graded_subj.py
